		...
		<div class="row TopHeader">
			<div class="row">
				...
				<div class="green">
					...
					<div class="col-md-4">
						<div class="thisRight"><a href="mailto:info@davkenyaltd.co.ke"><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp; info@davkenyaltd.co.ke</a> &nbsp; | &nbsp; <a href="#"><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;  0714 970 635</a></div>
					</div>
