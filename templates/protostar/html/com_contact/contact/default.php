...
<div class="contact<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Person">
	...
	<?php if ($this->params->get('show_info', 1)) : ?>
		...
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php //echo '<h3 claass="center-block hidden">' . JText::_('COM_CONTACT_DETAILS') . '</h3>'; ?>
		<?php endif; ?>
	...
	<?php if ($tparams->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php elseif ($presentation_style === 'plain') : ?>
			<?php //echo '<h3 class="text-center">' . JText::_('COM_CONTACT_EMAIL_FORM') . '</h3>'; ?>
			<?php echo '<div class="page-headerx sppb-row-containerx content-body containerxx">
				<h1 itemprop="name" class="content-body__h1">
			' . JText::_('COM_CONTACT_EMAIL_FORM') . '		</h1>
			</div>'; ?>
		<?php endif; ?>
	...
	<?php if ($this->contact->misc && $tparams->get('show_misc')) : ?>
		...
		<?php elseif ($presentation_style === 'tabs') : ?>
			...
			?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'display-misc', JText::_('Location')); ?>
		<?php elseif ($presentation_style === 'plain') : ?>
			<!-- <?php //echo '<h3>' . JText::_('COM_CONTACT_OTHER_INFORMATION') . '</h3>'; ?> //misc header -->
		<?php endif; ?>
