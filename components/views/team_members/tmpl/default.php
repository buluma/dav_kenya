...
<h1 class="content-body__h1">The Team</h1>

<div class="content-body__inner">
    <div id="content-body-01" class="content-body__container">
        <p class="">Kenya Unites is a youth-led multi-ethnic, multi-religious, multi-racial movement of peace, reconciliation and cohesion.:</p>
        
        <div class="content-body__team">
            <div class="content">
                <h2 class="">Meet the Kenya Unites Team</h2><br />
                        ...
                        <div class="modal-body">
                          ...
                          <div class="row">
                             <div class="col-md-6">
                               ...
                               <br />
                               <h4 class="text-center"><?php echo $item->name;?> - <?php echo $item->position;?></h4>
                             </div>
