...
if (version_compare(JVERSION, '3.7', 'lt')) {
	...
	class JFormFieldCustomFieldsList extends JFormField
	{
		...
		protected function getInput()
		{
			...
			$html .= '<span>';
			$html .= JText::sprintf('LIB_SYW_MESSAGE_NEEDJOOMLAFORCUSTOMFIELDS');
			$html .= '</span>';
			$html .= '</div>';
	...
	class JFormFieldCustomFieldsList extends JFormFieldList
	{
		...
		static function getCoreFields($context)
		{
			if (!isset(self::$core_fields)) {
				...
				self::$core_fields = FieldsHelper::getFields($context);
			}
		...
		public function setup(SimpleXMLElement $element, $value, $group = null)
		{
			...
			if ($return) {
				...
				$this->show_group = isset($this->element['show_group']) ? $this->element['show_group'] : true;
